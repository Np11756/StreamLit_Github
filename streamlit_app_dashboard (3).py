...
def load_data():
    ...
    # Simulate latitude and longitude from Dealer Region for the map
    region_coords = {
...
with tab1:
    st.markdown("## :white[Price Prediction Tool]")
    st.markdown(":white[This tool uses two machine learning models to estimate car sales price based on selected characteristics.]")
